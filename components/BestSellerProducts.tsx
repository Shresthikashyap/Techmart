...
export default function BestSellerProducts() {
  ...
  const { bestSellerProducts, fetchBestSellerProducts, error, isLoading } = useProductStore();
  ...
  return (
    <div className="container mx-auto px-4 py-8">
      <div className="flex flex-row justify-between items-center mb-6">
        ...
        <p
          className="text-gray-500 hover:text-gray-700 text-sm font-medium transition-colors cursor-pointer"
          onClick={() => router.push(`/all-products?type=bestseller`)}
        >
          View all
        </p>
        {/* </Link> */}
      ...
      {bestSellerProducts.length > 0 &&
          <Products products={bestSellerProducts} limit={4}/>
      }
